...
namespace LevvionSimple.Conditionals
{
	...
	public class FloatRange : MultiConditional
	{
		/// <summary>
		...
		public FloatRange(string id, float minvalue, float maxvalue, bool includeendpoints)
		{
		...
		public FloatRange(string id, float minvalue, float maxvalue, bool includeendpoints, Action action) : base(action)
		{
			SetRange(id, minvalue, maxvalue, includeendpoints);
		}
		...
		public FloatRange(string id, float minvalue, float maxvalue, bool includeendpoints, List<Action> actions) : base(actions)
		{
			SetRange(id, minvalue, maxvalue, includeendpoints);
		}
