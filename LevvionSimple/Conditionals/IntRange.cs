...
namespace LevvionSimple.Conditionals
{
	...
	public class IntRange : MultiConditional
	{
		/// <summary>
		...
		public IntRange(string id, int minvalue, int maxvalue, bool includeendpoints)
		{
		...
		public IntRange(string id, int minvalue, int maxvalue, bool includeendpoints, Action action) : base(action)
		{
			SetRange(id, minvalue, maxvalue, includeendpoints);
		}
		...
		public IntRange(string id, int minvalue, int maxvalue, bool includeendpoints, List<Action> actions) : base(actions)
		{
			SetRange(id, minvalue, maxvalue, includeendpoints);
		}
